...
function CsEventCard2() {
    return (
        <div className="cscard">
            ...
            <Card className="cseventcard">
                <Card.Img variant="top" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOKkOAIDdWEOtFyK2HmOBWCaxKx6J-NkxWOA&usqp=CAU" style={{height:'250px'}}/>
                <Card.Body style={{ color:'white', background: 'linear-gradient(to bottom left, #000066 0%, #9900cc 100%)'}}>
                    <Card.Title>FB Hunt</Card.Title>
                    <Card.Text>Create a single page website</Card.Text>
                    <div class="registerdiv">
                    <Link to="register">
                    <button class="regbtn">
                    Register
